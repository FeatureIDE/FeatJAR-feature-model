...
//    @Test
//    public void test1() {
//        IFormula test = new LessThan(new AttributeSum(new Name("cost")), new Constant(200L, Long.class));
...
//                new IntegerAdd(
//                        new IfThenElse(new Literal("cpu"), new Constant(10L, Long.class), new Constant(0L,
// Long.class)),
//                        new IfThenElse(
...
//    @Test
//    public void test2() {
//        IFormula test = new LessThan(new AttributeSum(new Name("cost")), new AttributeAverage(new Name("power")));
//        ReplaceAttributeAggregate replaceAttributeAggregate = new ReplaceAttributeAggregate(attributes, false);
//        Trees.traverse(test, replaceAttributeAggregate);
//
//        IFormula comparison = new LessThan(
...
//                new Implies(
//                        new Literal("cables"),
//                        new LessThan(new AttributeSum(new Name("cost")), new Constant(200L, Long.class))),
//                new Literal("case"));
//        ReplaceAttributeAggregate replaceAttributeAggregate = new ReplaceAttributeAggregate(attributes, false);
//        Trees.traverse(test, replaceAttributeAggregate);
//
