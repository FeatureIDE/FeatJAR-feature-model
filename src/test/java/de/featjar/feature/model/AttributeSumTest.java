...
public class AttributeSumTest {
    ...
    public void sum1() {
        ...
        IExpression comparison = new IntegerAdd(
                new IfThenElse(formulas.get(0), new Constant(1L, Long.class), defaultValue),
    ...
    public void sum2() {
        ...
        IExpression comparison = new RealAdd(
    ...
    public void sum3() {
        ...
        IExpression comparison =
                new IntegerAdd(new IfThenElse(formulas.get(0), new Constant(1L, Long.class), defaultValue));
