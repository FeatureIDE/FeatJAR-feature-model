...
//            attributes.put(
//                    Features.getFeatureFormula(feature),
//                    node.getFeature().getAttributes().get());
//        }
//
//        Result<IFeatureTree> potentialParentTree = node.getParent();
//        IFormula featureLiteral = Features.getFeatureFormula(node.getFeature());
...
//
//        } else {
//            return Features.getFeatureFormula(parent.getFeature());
//        }
//    }
//
...
//            pseudoLiterals.add(Features.getFeatureFormula(
...
//            featureLiteral = Features.getFeatureFormula(node.getFeature(), literalName);
//            handleParent(featureLiteral, node);
//
//            if (i > 1) {
...
//            constr.replaceChild(Features.getFeatureFormula(node.getFeature()), replacement);
...
//
//            IFormula nodeLiteral = Features.getFeatureFormula(node.getFeature());
//
...
//            IFormula childLiteral = Features.getFeatureFormula(childNode.getFeature());
//
...
//                        } else {
//                            constraints.add(new Implies(featureFormula, new AtMost(upperBound,
// groupLiterals.get(i))));
//                        }
//                    } else {
//                        if (upperBound != Range.OPEN) {
//                            constraints.add(new Implies(featureFormula, new AtLeast(lowerBound,
// groupLiterals.get(i))));
//                        }
//                    }
//                }
