...
//
//	Map<IFeature, IFormula> map = new LinkedHashMap<>();
//
//    public IFormula getFeatureFormula(IFeature feature) {
//        return getFeatureFormula(feature, feature.getName().orElse(""));
//    }
//
//    public IFormula getFeatureFormula(IFeature feature, String featureName) {
//    	IFormula formula = map.get(feature);
//    	if (formula == null) {
//    		formula = createFeatureFormula(feature, featureName);
//    		map.put(feature, formula);
//    	}
//		return formula;
//    }
//
//	private IFormula createFeatureFormula(IFeature feature, String featureName) {
