 ...
 */
public class ComputeFeatureGroupDistribution extends AComputation<HashMap<String, Integer>> {
    protected static final Dependency<IFeatureTree> FEATURE_TREE = Dependency.newDependency(IFeatureTree.class);

    public ComputeFeatureGroupDistribution(IComputation<IFeatureTree> featureTree) {
        super(featureTree);
    }
